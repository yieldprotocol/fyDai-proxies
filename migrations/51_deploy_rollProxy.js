...
module.exports = async (deployer, network) => {
  ...
  await deployer.deploy(RollProxy, controllerAddress, poolAddresses, proxyRegistryAddress)
  const rollProxy = await RollProxy.deployed()

  const deployment = {
    RollProxy: rollProxy.address,
  }
